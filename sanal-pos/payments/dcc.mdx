...
<Note>
DCC özelliği kuruluşunuzun banka anlaşmasında etkin olmalıdır ve **DCC'yi destekleyen
...
| `422` | `dcc_not_available` | Kuruluşunuz veya kart için DCC etkin değil |
