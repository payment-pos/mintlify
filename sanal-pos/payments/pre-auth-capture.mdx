...
| Olay | Açıklama |
|---|---|
| `sanalpos.payment.authorized` | Pre-Auth başarıyla alındı |
| `sanalpos.capture.completed` | Capture başarıyla tamamlandı |
| `sanalpos.void.completed` | Pre-Auth iptal edildi (capture'dan önce) |
