...
```json
{
  ...
  "status":              "pending",
  "is_success":          true,
  "message":             "Puan bakiyesi sorgulandı",
  "error_code":          null,
...
| HTTP | `error_code` | Anlam |
|---|---|---|
| `200` (gövdede `is_success: false`) | `POINT_INQUIRY_NOT_SUPPORTED` | Bu konnektör puan sorgusu desteklemiyor |
| `200` (gövdede `is_success: false`) | `POINT_INQUIRY_FAILED` | Banka puan sorgusunu reddetti |
| `200` (gövdede `is_success: false`) | `POINT_INQUIRY_EXCEPTION` | Sorgu sırasında exception |
