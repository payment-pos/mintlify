...
Payven her webhook isteğinde **HMAC-SHA256 imza** gönderir. Bu imza, isteğin gerçekten Payven'den geldiğini ve gövdesinin değiştirilmediğini garanti eder. Public webhook endpoint'inizi açıyorsanız imza doğrulama **zorunludur**.
...
```
imzalanacak_string = "<X-Payven-Timestamp>" + "." + "<istek_gövdesinin_raw_string'i>"
...
```bash
curl -X POST https://vpos.payven.com.tr/api/v1/webhooks/8e3f5c12-.../rotate-secret \
