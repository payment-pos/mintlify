...
`unknown_error` — konnektörden gelen kod Payven eşleme tablosunda yok. Bu durumlarda ham mesaj `detail` alanında bulunur. Lütfen `correlationId` ile birlikte [destek ekibimize](/resources/support) yazın — eşleme tablosunu güncelleyebiliriz.
