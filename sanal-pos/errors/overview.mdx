...
|---|---|
| `code` (problem+json hata gövdesinde) | Payven domain veya HTTP canonical |
...
| `forbidden`, `merchant_inactive`, `product_not_licensed` | İlgili kuruluş yöneticisi / Payven satış ile iletişime geçin |
