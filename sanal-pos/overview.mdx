...
| Webhook yönetimi | Sanal POS API'sinde değil **İşyeri API'sinde**: `POST /webhook-endpoints`, `POST /webhook-endpoints/{id}/rotate-secret`, `GET /webhook-endpoints/{id}/deliveries` — bkz. [Webhook'lar](/documentation/concepts/webhooks) | Bearer |
