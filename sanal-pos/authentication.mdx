...
JWT token'ı içinde `merchantId` claim'i taşınır — tek-merchant tenant'larda ek bir header göndermenize gerek yoktur. Backend, claim'den okuyarak işlemi doğru merchant adına kayıt eder.
