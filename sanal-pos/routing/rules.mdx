...
| `currency` | string | ❌ | `TRY`, `USD`, `EUR`, `GBP` (boş = her para birimi) |
...
Engine kuralı eşleşen aday konnektörler için kompozit skor üretir:
...
| HTTP | `code` | Anlam |
|---|---|---|
| `404` | `PV_CONNECTOR_NOT_FOUND` | `target_connector_config_id` veya `fallback_connector_config_id` bulunamadı |
