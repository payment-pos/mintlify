...
| `X-Tenant-Id` | UUID | Kuruluşunuzun tenant kimliği. Multi-tenant izolasyon için zorunludur. |
...
`tenant-admin` rolü, transfer rollerini de kapsar (composite). Detay: kuruluşunuzun rol matrisini konsoldan **Ayarlar → Kullanıcılar** ekranından inceleyebilirsiniz.
