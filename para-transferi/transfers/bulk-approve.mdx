---
title: "2. Adım — Transfer Onayla (Approve)"
...
<Note>
**Aynı kullanıcı oluşturup onaylayabilir mi?** Backend tarafında engellenmez — ancak **iç güvenlik politikanız** bunu zorunlu kılmalıdır. Kuruluşunuzun rol matrisinde `transfer-operator` ve `transfer-admin` rollerinin farklı kullanıcılara verilmesi 4-eyes principle'ın anlamlı uygulamasını sağlar.
</Note>
