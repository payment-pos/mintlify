...
Banka tarafı detayını sonradan `GET /api/v1/transfers/{id}` ile sorgulayabilirsiniz; `error_code` ve `provider_error_code` alanları response body'sinde data olarak taşınır.
