...
<Tabs>
  ...
  <Tab title="API Anahtarı">
    ...
    API anahtarı **kuruluş seviyesindedir** — aynı çiftle kuruluşa bağlı tüm merchant'lar adına işlem yapabilirsiniz. Hangi merchant adına işlem yaptığınızı her istekte ilgili merchant header'ı ile belirtirsiniz.
  </Tab>
</Tabs>
