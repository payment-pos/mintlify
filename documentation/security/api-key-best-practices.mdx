...
<Steps>
  <Step title="Yeni client veya secret üretin">
    Konsol → API Anahtarları → **Yeni Anahtar Oluştur** (veya mevcut anahtar için **Secret Rotate**). Mevcut secret'ı **silmeyin** — geçiş penceresinde iki secret de kabul edilir.
  </Step>
