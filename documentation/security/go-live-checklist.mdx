...
<Checkbox> Endpoint **15 saniyenin altında** yanıt veriyor (ağır iş kuyruğa atılıyor). </Checkbox>
<Checkbox> Aynı `eventId` ile gelen olaylar **idempotent** işleniyor. </Checkbox>
