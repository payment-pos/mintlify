...
<Note>
**Ön koşul:** [Konsol](https://dashboard.payven.com.tr) üzerinde bir kuruluşunuz ve `client_id` / `client_secret` çiftiniz olmalıdır. Onboarding için satış ekibimize ulaşın.
</Note>
