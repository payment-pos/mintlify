...
**Access token 5 dakika geçerlidir.** Production'da bunu cache'leyip auto-refresh ile yönetin — örnek istemciler: [Kimlik Doğrulama → Kod örnekleri](/documentation/concepts/authentication#kod-ornekleri-auto-refresh).
...
Sandbox test kartları organizasyonunuzun aktif konnektör konfigürasyonuna göre değişir (mock konnektör vs banka test ortamı). Güncel matris konsoldan derlenir:
