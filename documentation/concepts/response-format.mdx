...
<Note>
**Banka reddi de hata response'udur.** Gateway'e ulaşmış ama banka tarafında reddedilen
bir ödeme `422 Unprocessable Entity` + `application/problem+json` ile döner;
response body'de `code: "bank_declined"` ve banka ham yanıt kodu (`provider_error_code`,
