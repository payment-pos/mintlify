...
Yabancı para biriminde işlem için kullanılan **DCC (Dynamic Currency Conversion)** akışı, müşteriye işlem anında kart para biriminde tutarı gösterir. Detay: [DCC Akışı](/sanal-pos/payments/dcc).
