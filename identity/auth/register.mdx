...
| `company_name` | string | ✅ | Şirket adı (profil özniteliği olarak saklanır) |
| `password` | string | ✅ | Sistem parola politikasına uygun (min uzunluk + karakter çeşitliliği) |
...
| Alan | Açıklama |
|---|---|
| `user_id` | Oluşturulan kullanıcının kimliği |
...
```mermaid
flowchart LR
    A[POST /register] --> B[Kullanıcı oluşturuldu<br/>Enabled=false<br/>pendingApproval=true]
...
| `422` | `weak_password` | Parola güvenlik politikasına uymuyor |
