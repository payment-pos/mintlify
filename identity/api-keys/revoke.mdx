...
| Kalıcı sil | `DELETE /api/v1/tenants/me/api-keys/{id}` | ❌ Hayır — geri alınamaz |
...
<Warning>
Silme **geri alınamaz**. Anahtar kaydı kalıcı olarak silinir; aynı `client_id` tekrar üretilmez — yeni bir anahtar oluşturmanız gerekir.
</Warning>
