...
| Kalıcı sil | `DELETE /api/v1/tenants/me/api-keys/{id}` | ❌ Hayır — Keycloak client da silinir |
...
<Warning>
Silme **geri alınamaz**. Identity DB kaydı + Keycloak client beraber silinir. `client_id` değeri tekrar üretilmez — yeni bir anahtar oluşturmanız gerekir.
</Warning>
