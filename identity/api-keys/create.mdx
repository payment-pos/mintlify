...
description: "Konsoldan veya API üzerinden Keycloak service-account client'ı üretin."
---
...
JWT içinde `tenant_id`, `merchant_id`, `plan_code`, `daily_limit`, `monthly_limit`, `rate_limit` claim'leri taşınır — Composer'lar bunları doğrudan validate eder, Identity'ye HTTP atmaz.
