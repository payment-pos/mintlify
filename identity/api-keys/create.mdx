...
| `merchant_id` | string | ❌ | Default merchant external ID — access token claim'ine yansır |
...
Aldığınız `client_id` + `secret` ile [Identity'den access token alın](/documentation/concepts/authentication):
