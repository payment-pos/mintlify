...
Bu liste **çok nadir** değişir (yeni ilçe atanması nadirdir). İstemcinizde **7 günlük** cache uygulayabilirsiniz. Composer'ların iç kullanımı için Identity zaten 1 saatlik in-memory cache uygular.
