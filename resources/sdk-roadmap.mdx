...
<Tip>
Üretilen istemcide `Authorization: Bearer ...` header'ını manuel set etmeniz veya bir interceptor yazmanız gerekir. Token alma (Identity `/auth/{slug}/token`) için kanonik [Kimlik Doğrulama kod örnekleri](/documentation/concepts/authentication#kod-ornekleri-auto-refresh) kopyalanabilir.
</Tip>
...
<CardGroup cols={2}>
  <Card title="Deneme paneli" icon="flask" href="/api-reference/sanal-pos">
  ...
  <Card title="Webhook Teslim Kayıtları" icon="bell" href="/documentation/concepts/webhooks">
    Her teslimin ve denemesinin HTTP kodu, süresi ve yanıtı; tek tıkla yeniden gönderim.
  </Card>
</CardGroup>
