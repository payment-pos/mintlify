...
Asenkron çalışır — sonucu status polling ile bekleyin (mutabakat için webhook olayı henüz yayınlanmaz):
...
# Status polling "completed" döndüğünde
...
<Check>Mutabakat sonucu (status polling) operasyon kuyruğuna mesaj atıyor mu?</Check>
