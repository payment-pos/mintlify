...
sequenceDiagram
    ...
    Payven-)App: webhook: sanalpos.payment.completed | sanalpos.payment.failed
```
...
<Check>`sanalpos.payment.failed` webhook'u handler'ınız retry kuyruğuna yazıyor mu?</Check>
