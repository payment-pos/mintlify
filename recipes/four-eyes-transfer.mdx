...
sequenceDiagram
    ...
    Payven-)App: webhook: para-transferi.transfer.completed | para-transferi.transfer.failed (her transfer için)
```
...
<Check>Webhook handler'ınız `para-transferi.transfer.completed` ve `para-transferi.transfer.failed` olaylarını dinliyor mu?</Check>
